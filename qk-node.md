...
下载安卓[qkiNode2.0.6.apk](https://220250729.xyz/app/dev.qki.node/qkiNode2.0.6-release-2025-08-01-09-46.apk)，然后运行打开即可。
...
`docker run -d --name watchtower --restart unless-stopped -v /var/run/docker.sock:/var/run/docker.sock chenjia404/watchtower --cleanup -i 86400`

5. 下载快照(可选，加快同步速度)
```shell
rm qk_poa/geth/chaindata -rf
wget https://files.qkiscan.io/chaindata20260104.zip
unzip chaindata20260104.zip -d qk_poa/geth
```
